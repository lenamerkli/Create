...
public class CLogistics extends ConfigBase {
	...
	public final ConfigInt displayLinkRange = i(256, 1, "displayLinkRange", Comments.displayLinkRange);
	public final ConfigInt vaultCapacity = i(20, 1, "vaultCapacity", Comments.vaultCapacity);
	public final ConfigInt brassTunnelTimer = i(2, 1, 10, "brassTunnelTimer", Comments.brassTunnelTimer);
