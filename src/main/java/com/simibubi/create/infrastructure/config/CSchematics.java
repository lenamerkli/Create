...
public class CSchematics extends ConfigBase {
	...
	public final ConfigInt maxTotalSchematicSize = i(1024 * 16, 16, "maxSchematics", Comments.kb, Comments.maxSize);
	public final ConfigInt maxSchematicPacketSize =
		i(1024 * 16, 256, 32767, "maxSchematicPacketSize", Comments.b, Comments.maxPacketSize);
